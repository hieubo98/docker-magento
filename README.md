...
2.  Next, enable Xdebug in the PHP-FPM container by running: `bin/xdebug24x enable` OR `bin/xdebug23x enable` , the restart the docker containers (CTRL+C then `bin/start`).
